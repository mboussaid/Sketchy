class Sketchy{
    ...
    addElements(){
        ...
        this.canvas.classList.add('sketchRecorderCanvas')
        ...
        this.sideBar.classList.add('sketchRecorderSideBar')
        this.toolBar = document.createElement('div')
        this.toolBar.classList.add('sketchRecorderToolBar')
        ...
        this.penButton.classList.add('sketchRecorderSideBarButton')
        this.eraserButton.classList.add('sketchRecorderSideBarButton')
        ...
        this.data.colors.forEach(color=>{
            ...
            btn.classList.add('sketchRecorderSideBarButton')
        ...
        // this.recordButton.classList.add('sketchRecorderToolBarButton')
        this.captureButton.classList.add('sketchRecorderToolBarButton')
